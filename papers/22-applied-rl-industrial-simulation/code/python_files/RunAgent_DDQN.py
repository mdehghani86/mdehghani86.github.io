...
try:
    ...
    eps_array = pickle.load(open('./results/DDQN/eps_array.pickle', 'rb'))
    scores_array = pickle.load(
        open('./results/DDQN/scores_array.pickle', 'rb'))
    loss_array = pickle.load(open('./results/DDQN/loss_array.pickle', 'rb'))
    cycletime_array = pickle.load(
        open('./results/DDQN/cycletime_array.pickle', 'rb'))
    ...
    pickle.dump(eps_array, open('./results/DDQN/eps_array.pickle', 'wb'))
    pickle.dump(scores_array, open('./results/DDQN/scores_array.pickle', 'wb'))
    pickle.dump(loss_array, open('./results/DDQN/loss_array.pickle', 'wb'))
    pickle.dump(cycletime_array, open(
        './results/DDQN/cycletime_array.pickle', 'wb'))
