...
try:
    ...
    scores_array = pickle.load(open('./results/SAC/testscores_array.pickle', 'rb'))
    cycletime_array = pickle.load(open('./results/SAC/testcycletime_array.pickle', 'rb'))
    ...
    pickle.dump(scores_array, open('./results/SAC/testscores_array.pickle', 'wb'))
    pickle.dump(cycletime_array, open('./results/SAC/testcycletime_array.pickle', 'wb'))
