...
try:
    ...
    scores_array = pickle.load(
        open('./Results/Tabular/testscores_array.pickle', 'rb'))
    cycletime_array = pickle.load(
        open('./results/Tabular/testcycletime_array.pickle', 'rb'))
    ...
    pickle.dump(scores_array, open(
        './Results/Tabular/testscores_array.pickle', 'wb'))
    pickle.dump(cycletime_array, open(
        './results/Tabular/testcycletime_array.pickle', 'wb'))
